-- ============================================================================
-- squishy — seed Oracle (19c)
-- Port du seed 23ai avec :
--   * c_bool : TRUE/FALSE → 1/0 (pas de littéraux booléens en SQL 19c)
--   * Connexion PDB : FREEPDB1 → ORCLPDB1
...
-- c_bool : NUMBER(1) CHECK IN (0,1) — pas de TRUE/FALSE natif avant 23c.
